...
import type { EmployeeRef, EnrichedLeave, LeaveRequest } from '@/lib/attendance-types'
    ...
    <div className='flex flex-col'>
      ...
      {records === undefined ? (
        ...
        <>
          ...
          <LeaveBalanceSection employees={employees} leaveRequests={leaveRequests} />
        </>
      )}
      <RaiseLeaveDialog employees={employees} open={raiseOpen} onOpenChange={setRaiseOpen} />
    </div>
  )
}