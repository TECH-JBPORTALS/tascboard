...
type Props = { employees: EmployeeRef[]; open: boolean; onOpenChange: (v: boolean) => void }
...
export function RaiseLeaveDialog({ employees, open, onOpenChange }: Props) {
  ...
  const reset = () => { setEmployeeId(''); setLeaveType('casual'); setStartDate(''); setEndDate(''); setReason('') }
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='max-w-sm'>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSubmit} disabled={!employeeId || !startDate || !endDate || !reason}>Submit</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  )
