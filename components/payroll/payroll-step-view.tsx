...
export const E1: S1 = { avatarUrl: null, employeeId: '', employeeName: '', employeeRole: '' }
export const E2: S2 = { basicSalary: '', overtimePay: '' }
export const E3: S3 = { addBonus: false, bonus: '', deduction: '', incentive: '' }
  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Who is this payroll for?</p>
      </div>
